...
<div class="row row-xs">
	...
	<!-- col -->
	@canany(['download-shipment-track-report'])
	<div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0 mg-b-10">
		<div class="card card-body">
			<div class="media">
				<div class="wd-40 wd-md-50 ht-40 ht-md-50 bg-teal tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded op-6">
				...
				<div class="media-body">
					<h6 class="tx-sans tx-uppercase tx-10 tx-spacing-1 tx-color-03 tx-semibold tx-nowrap mg-b-5 mg-md-b-8">Reports</h6>
					<h4 class="tx-20 tx-sm-18 tx-md-24 tx-normal tx-rubik mg-b-0"><a href="{{ route('shipmenttrackreport') }}">Shipment Track Report</a></h4>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- col -->
	@canany(['price-inventory-import-export'])
	<div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0 mg-b-10">
		<div class="card card-body">
			<div class="media">
				<div class="wd-40 wd-md-50 ht-40 ht-md-50 bg-teal tx-white mg-r-10 mg-md-r-10 d-flex align-items-center justify-content-center rounded op-6">
				...
				<div class="media-body">
					<h6 class="tx-sans tx-uppercase tx-10 tx-spacing-1 tx-color-03 tx-semibold tx-nowrap mg-b-5 mg-md-b-8">Reports</h6>
					<h4 class="tx-20 tx-sm-18 tx-md-24 tx-normal tx-rubik mg-b-0"><a href="{{ route('import-export-price-list') }}">Price Inventory Report</a></h4>
				</div>
			</div>
		</div>
	</div>
