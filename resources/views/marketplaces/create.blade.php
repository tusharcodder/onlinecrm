		...
		<div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
					...
					<form method="POST" action="{{ route('marketplaces.store') }}">
					@csrf
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input id="number" type="number" class="form-control" name="number" value="{{ old('number') }}"  autocomplete="number">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="address" name="address" class="form-control" rows="4" cols="50">{{ old('address') }}</textarea>
								</div>
							</div>
						</div>
