			...
			<div class="card">
				...
				<div class="card-body">
					...
					<span class="help-block mb-3">
						...
						<small>	<i class="fa fa-download"></i><a href="{{asset('usps_zone.csv')}}" download> Click To Download Format</a> </small>
					</span>
					<form action="{{ route('download-usps-price-detail') }}" method="POST" enctype="multipart/form-data">
						@csrf
						<div class="row mt-3">
							<div class="col-md-5">
