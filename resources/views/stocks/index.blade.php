            ...
            <div class="card">
                <div class="card-header">
					...
					<div class="float-right">
						@can('stock-create')
							<a class="btn btn-success btn-sm" href="{{ route('stocks.create') }}"> Add New Stock</a>
						@endcan
						@can('stock-threshold')
							<a class="btn btn-primary btn-sm" href="{{ route('stockthreshold.create') }}"> Stock threshold</a>
						@endcan
						@can('stock-import-export')
							<a class="btn btn-secondary btn-sm" href="{{ route('stock-import-export') }}"> Stock import/export</a>
						@endcan
						@can('stock-out-export')
							<a class="btn btn-danger btn-sm" href="{{ route('stock-out-export') }}"> Get out of stock list</a>
						@endcan
						@can('stock-low-export')
							<a class="btn btn-danger btn-sm" href="{{ route('stock-low-export') }}"> Get low stock list</a>
						@endcan
						@if(!empty($search))
