								...
								<div class="form-group">
									...
									<select class="form-control" id="vendor_name" name="vendor_name" required>
										...
										@foreach ($vendor as $key => $val)
											<option value="{{ $val->id }}" {{ $val->id == old('vendor_name', $stock->vendor_id) ? 'selected' : '' }}>{{ $val->name }}</option>
										@endforeach
									</select>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<select class="form-control" id="binding_type" name="binding_type" required>
										...
										@foreach ($binding as $key => $val)
											<option value="{{ $val->id }}" {{ $val->id == old('binding_type', $stock->binding_id) ? 'selected' : '' }}>{{ $val->name }}</option>
										@endforeach
									</select>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<select class="form-control" id="currency" name="currency" required>
										...
										@foreach ($currency as $key => $val)
											<option value="{{ $val->id }}" {{ $val->id == old('currency', $stock->currency_id) ? 'selected' : '' }}>{{ $val->name }}</option>
										@endforeach
									</select>
								</div>
							</div>
